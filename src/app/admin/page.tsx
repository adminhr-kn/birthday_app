		...
		<div className="min-h-screen  p-4 sm:p-6 lg:p-8">
			<div className="container mx-auto max-w-7xl">
				<div className="space-y-8">
						...
						<div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full mb-4">
							<svg
								...
								<path
									...
									strokeWidth={2}
									d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-1a.5.5 0 01-.5.5h-1.5a.5.5 0 01-.5-.5v-2a.5.5 0 01.5-.5H19a.5.5 0 01.5.5v2z"
								/>
							</svg>
						</div>
					...
					{/* Search Bar */}
					{/* flex will change the automatic div width so we give a w-full inside the component */}
							...
							<Table>
								<TableHeader>
									<TableRow className="border-white/10 hover:bg-white/5">
										<TableHead className="text-white font-semibold text-left px-6 py-4">
											Name
										</TableHead>
